...
export function Home(props: HomeProps) {
  const socialMedias: IconInterface[] = [
    {
      name: 'LinkedIn',
      icon: <FaLinkedinIn width={16} height={16}/>,
      color: 'linkedin',
      link: 'https://www.linkedin.com/in/ghaith-saidani-9230571b2/'
    },
    {
      name: 'Github',
      icon: <SiGithub width={16} height={16} />,
      color: 'github',
      link: 'https://github.com/ghaithsaidani'
    },
    {
      name: 'LeetCode',
      icon: <SiLeetcode width={16} height={16}/>,
      color: 'leetCode',
          ...
          <h1 className={'font-sfPro xl:text-[1.5rem] 2xl:text-[2rem]'}>
            ...
            <Reveal>
              ...
              <TypeAnimation
                ...
                wrapper="span"
                speed={5}
                style={{ display: 'inline-block', color: 'hsl(var(--primary))' }}
                repeat={Infinity}
              />
            ...
            <ul className={'grid gap-y-4'}>
              {socialMedias.map((socialMedia) => (
                <li
                  ...
                  className={`grid group relative bg-transparent border-[1px] border-primary text-primary hover:border-transparent social cursor-pointer place-items-center xl:h-10 xl:w-10 2xl:h-[120%] 2xl:w-[120%] rounded-full p-2 transition-colors duration-500  hover:bg-transparent hover:text-white overflow-hidden`}
                >
                  <a
